    ...
    return (
        <section className="relative py-32 md:py-48 overflow-hidden" style={{ backgroundColor: 'var(--color-ink)' }}>
            ...
            <SectionReveal className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 text-center">
                <RevealItem>
                    <span className="text-xs tracking-[0.2em] uppercase mb-6 block font-bold"
                ...
                <RevealItem>
                    ...
                    >
                        Tools for the <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-blue-primary)] to-[var(--color-accent)]">Modern Neuroengineer.</span>
                    </h1>
                </RevealItem>
